...
<div style="border: 5px double black; padding: 20px; background-color: #f5f0e1; font-family: 'Georgia', serif;">
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 15px;">
    ...
    <div style="flex: 1; text-align: center;">
      ...
      <p>
        <i>🚨 A data-driven snapshot of alcohol-related deaths</i>
      </p>
    </div>
  </div>
  <hr />
  <p> Understanding alcohol-specific death patterns is essential due to their profound social, economic, and healthcare implications.
  <div style="display: flex; flex-wrap: wrap; gap: 15px;">
    <!-- Right column for image -->
    <div style="flex: 1; text-align: center;">
